...
[v1.0.0](https://github.com/chipkin/BACnetProfileExample-B-ALSC-CPP/releases/tag/v1.0.0)
...
v1.0.0 was published from a prebuilt STATIC-linked stack library, but this
repository now builds and ships in the adapter's default **SOURCE** mode (see
[Build](#build) above); the next release refreshes this table from that build.
